...
void loop() {
  ...
  potDC1 = 100; potDC2 = 100; potDC3 = 0; potDC4 = 0;
...
/*    if (Serial.available() > 0) {
                ...
                if (incomingByte = 1) potDC1 = 100;
                if (incomingByte = 0) potDC1 = 0;
...
*/  
  ...
  Serial.print(P1); Serial.print("\t"); //Red on plot monitor
  Serial.print(P2); Serial.print("\t"); //Blue on plot monitor
  Serial.print(P3); Serial.print("\t"); //3 and 4 are yellow and green (order unknown)
  Serial.print(P4); Serial.print("\n");

/*Serial.print("Switch 1: "); Serial.print(digitalRead(50)); Serial.print("Pot. 1: ");Serial.print(analogRead(A1)); Serial.print("\t");
Serial.print("Switch 2: "); Serial.print(digitalRead(51)); Serial.print("Pot. 2: ");Serial.print(analogRead(A2)); Serial.print("\t");
Serial.print("Switch 3: "); Serial.print(digitalRead(52)); Serial.print("Pot. 3: ");Serial.print(analogRead(A3)); Serial.print("\t");
Serial.print("Switch 4: "); Serial.print(digitalRead(53)); Serial.print("Pot. 4: ");Serial.print(analogRead(A4)); Serial.print("\n");*/
